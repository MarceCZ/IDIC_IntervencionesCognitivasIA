...
def record_until_silence(ip, port, out_wav, **params):
    ...
    # [TIMELINE-MS] ADDED: capturar el instante relativo (s) del primer inicio de voz
    ...
    try:
        while True:
            ...
            # [TIMELINE-MS] ADDED: primera transición silencio → voz
            ...
            # Parada global: silencio sostenido largo
        ...
        # [TIMELINE-MS] ADDED: devolver el instante relativo del primer inicio de voz (o None)
